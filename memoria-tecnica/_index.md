...
- [[google-search-console-setup]] — Concluída: verificação por Tag HTML, sitemap enviado (13
  páginas), home indexada. Bug documentado: "Arquivo HTML" não funciona neste site (cleanUrls)
